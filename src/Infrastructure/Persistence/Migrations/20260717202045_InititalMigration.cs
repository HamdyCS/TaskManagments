        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WorkSpaceInviteStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WorkSpaceRole = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifyToId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TaskId = table.Column<long>(type: "bigint", nullable: true),
                    WorkSpaceInviteId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Notifications_Users_NotifyToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskAssignments_Users_AssignedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskId = table.Column<long>(type: "bigint", nullable: false),
                    CommentById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskComments_Users_CommentById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "A09FD502-5A6A-4B67-90F7-20A0C8586B29", "Admin", "ADMIN" },
                    { "2", "5551BA14-D8BD-4622-99D3-2EABE5E851C7", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_NotifyToId_CreatedAt",
                table: "Notifications",
                columns: new[] { "NotifyToId", "CreatedAt" },
                filter: "[IsRead] = 0");
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "ExpiresAt", "CreatedAt", "IsRevoked" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_TaskId_AssignedToId",
                table: "TaskAssignments",
                columns: new[] { "TaskId", "AssignedToId" });
