...
{
    public class ConfirmationEmailBgService(IConfirmationEmailQueue confirmationEmailQueue, IServiceScopeFactory serviceScopeFactory, ILogger<ConfirmationEmailBgService> logger) : BackgroundService
    {
